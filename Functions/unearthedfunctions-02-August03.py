...
class DriveBase_Contorller(object):
    def __init__(self, lfmotor: Motor, rgmotor: Motor, oneunit: int, scaleunit: int, wheelerror: int = None, distbetweenwheel: int = 0, wheelcircumference: int = 0) -> None:
        ...
        self.position: int = 0; self.lasttposition: int = 0
        ...
        self.typefunction: int = 0; # 1 for leftt, 2 for rightt
    ...
    async def turnleftspeed(self, angle: int, speedangle: int, *, error: int = 5, lfsign: int = -1, rgsign: int = 1) -> None:
        ...
        angle = -myabs(angle); error = -myabs(error)
    ...
    async def turnleftpid(self, angle: int, speedangle: int, *, lfsign = -1, rgsign = 1) -> None:
        ...
        # await wait(250)
        # print(self.setpoint, self.getangle())
...
async def main() -> None:
    ...
    mydrivebase.PID.setconstants(1250, 0, 2)
    mydrivebase.PID_turn.setconstants(200, 0, 1)
    
    await mydrivebase.turnleftpid(90, 150)
    ...
    # mydrivebase.PID.compute(123, 1); 
    # print(mydrivebase.PID.controlleroutput)
