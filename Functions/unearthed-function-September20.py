...
class runmethods(object):
    ...
    async def runk2(self): 
        ...
        await mydrivebase.turnleftt(90, 120, typestop = mydrivebase.braketank); await wait(1000)
        await mydrivebase.turnrightt(90, 120, typestop = mydrivebase.braketank); await wait(1000)
