...
class runmethods(object):
    ...
    async def runk1(self): 
        ...
        await mydrivebase.gyroforwards(412, 1000, typestop = mydrivebase.braketank, offsetlf = 32); await wait(500)
        await mydrivebase.gyroforwards(132, 625, typestop = mydrivebase.braketank, offsetlf = 64); await wait(250)
    ...
    async def runk3(self):
        ...
        await mydrivebase.gyroforwards(780, 700, typestop= mydrivebase.braketank); await wait(100)
        await mydrivebase.turnleftt(39, 50, lfsign=-1, rgsign=0,typestop = mydrivebase.braketank); await wait(100)

        await mydrivebase.gyrobackwards(160, 600, typestop = mydrivebase.braketank); await wait(100)
        await mydrivebase.turnleftt(9, 50, typestop=mydrivebase.braketank)
        await rundegrees(mydrivebase.sysrighttmotor, 150, 150) ; await wait(100)
