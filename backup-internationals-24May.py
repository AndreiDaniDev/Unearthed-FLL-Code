...
class runmethods(object):
    ...
    async def runk1(self): 
        ...
        await mydrivebase.gyrobackwards(728, 975, typestop = mydrivebase.braketank, initpid = 1); await wait(250)
        ...
        await mydrivebase.gyroforwards(267, 825, typestop = mydrivebase.braketank, initpid = 1); await wait(250)
        
        await multitask(
            mydrivebase.trytimelimit(lambda: mydrivebase.sysrighttmotor.run_angle(275, -220), 3000, typestop = mydrivebase.sysrighttmotor.hold),# ---> if we have a bad run and can't complete the shark we will get tle and exit :D <--- #
            delayfunction(575, lambda: mydrivebase.trytimelimit(lambda: mydrivebase.turnleftt(20, 32, lfsign = -1, rgsign = 1, typestop = mydrivebase.braketank, lowerspeedbound = 32), 1500, mydrivebase.braketank))
    ...
    async def runk2(self): 
        ...
        mydrivebase.PID.setconstants(1750, 0, 2, alphanoise = 875, deadzone = 0); await wait(200)
        ...
        await multitask( # before dist 715, now 708 (blind modification) # 
            mydrivebase.gyroforwards(708, 675, typestop = mydrivebase.braketank, initpid = 1), 
