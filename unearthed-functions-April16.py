...
class runmethods(object):
    ...
    async def runk1(self): 
        ...
        await mydrivebase.turnleftt(92, 45, typestop=mydrivebase.braketank); await wait(200)
        await mydrivebase.gyroforwards(250, 300, initpid=0, typestop=mydrivebase.braketank); await wait(200)

        
        mydrivebase.syslefttmotor.run_angle(370, 1100);
        await rundegrees(mydrivebase.sysrighttmotor, -290, 3500)
        await mydrivebase.gyrobackwards(130, 170, typestop=mydrivebase.braketank)

        await multitask(
            mydrivebase.turnrightt(45, 45, rgsign=0, lfsign=1, typestop=mydrivebase.braketank),
            mydrivebase.sysrighttmotor.run_angle(310, 400)
        ); await wait(200)

        await mydrivebase.gyroforwards(400, 800, typestop=mydrivebase.braketank)
    ...
    async def runk7(self):
        ...
        await rundegrees(mydrivebase.sysrighttmotor, 500, 700); await wait(200)                       
        await rundegrees(mydrivebase.sysrighttmotor, -500, 700)                                       
        await mydrivebase.gyroforwards(370, 500, typestop=mydrivebase.braketank)                      
        ...
        await rundegrees(mydrivebase.syslefttmotor, 660, 660)
