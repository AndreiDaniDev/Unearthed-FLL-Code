...
class runmethods(object):
    ...
    async def runk3(self):
        ...
        await mydrivebase.gyroforwards(750, 700, typestop= mydrivebase.braketank); await wait(100)
        await mydrivebase.turnleftt(45, 50, lfsign=-1, rgsign=1,typestop = mydrivebase.braketank); await wait(100)

        await mydrivebase.gyrobackwards(165, 600, typestop = mydrivebase.braketank)
        await rundegrees(mydrivebase.syslefttmotor, -180, 150)
        await rundegrees(mydrivebase.sysrighttmotor, 133, 150) ; await wait(100)

        await mydrivebase.gyroforwards(180, 600, typestop = mydrivebase.braketank)
        await rundegrees(mydrivebase.syslefttmotor, 90, 250)
        await rundegrees(mydrivebase.sysrighttmotor, -137, 150)
