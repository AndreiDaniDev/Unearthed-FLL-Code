...
class runmethods(object):
    ...
    async def runk1(self): 
        ...
        mydrivebase.PID.setconstants(925, 0, 1); await wait(200)
        
        # ------------------------------------------------------------------------------------------ #
        
        await multitask(
              mydrivebase.gyrobackwards(830, 830, typestop=mydrivebase.braketank),
              rundegrees(mydrivebase.sysrighttmotor, 310, 600)
        
        );await wait(250)

        await mydrivebase.turnleftt(91, 45, typestop=mydrivebase.braketank); await wait(200)
        await mydrivebase.gyroforwards(250, 220, initpid=0, typestop=mydrivebase.braketank); await wait(200)

        
        await mydrivebase.syslefttmotor.run_angle(1100, 240);
        ...
        await multitask(
            mydrivebase.turnrightt(40, 35, rgsign=0, lfsign=1, typestop=mydrivebase.braketank),
        ...
        #await multitask(
        await mydrivebase.sysrighttmotor.run_angle(1100, -70),
        ...
        await mydrivebase.turnrightt(45, 60, typestop=mydrivebase.braketank)
    ...
    async def runk5(self): # ---> Stones (needs a lot of tuning with the new sistem) <--- #
        ...
        await multitask(
            delayfunction(575, lambda: mydrivebase.gyroforwards(250, 1100, typestop = mydrivebase.braketank, initpid = 0)),
        ...
        await multitask(
            ...
            mydrivebase.trytimelimit(lambda: mydrivebase.sysrighttmotor.run_angle(775, -825), 2000, None)
        ); await wait(250)
