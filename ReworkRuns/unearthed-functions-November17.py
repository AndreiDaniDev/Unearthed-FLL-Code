...
class runmethods(object):
    ...
    async def runk3(self):
        ...
        await mydrivebase.gyroforwards(640, 700, typestop= mydrivebase.braketank);await wait(250)
        await mydrivebase.gyrobackwards(70, 800, typestop = mydrivebase.braketank);await wait(250)
        await rundegrees(mydrivebase.syslefttmotor, 200, 200);await wait(250)
        await mydrivebase.gyroforwards(20, 400, typestop=mydrivebase.braketank)
        await rundegrees(mydrivebase.syslefttmotor, -210, 600);await wait(250)
        await rundegrees(mydrivebase.syslefttmotor, 200, 200);await wait(250)
        await mydrivebase.gyroforwards(190, 700, typestop=mydrivebase.braketank);await wait(250)
        await mydrivebase.turnleftt(35, 70, rgsign=0, typestop = mydrivebase.braketank); await wait(250)

        await mydrivebase.gyrobackwards(140, 600, typestop = mydrivebase.braketank); await wait(250)
        await mydrivebase.turnleftt(15, 26, typestop=mydrivebase.braketank)
        ...
        await mydrivebase.turnrightt(35, 50, lfsign=1, rgsign=-1, typestop=mydrivebase.braketank)
    ...
    async def runk5(self): # ---> Stones (needs a lot of tuning with the new sistem) <--- #
        ...
        mydrivebase.syslefttmotor.run_angle(1000, 175)
        await mydrivebase.gyroforwards(155, 525, typestop = mydrivebase.braketank); await wait(200)
        await mydrivebase.turnleftt(30, 32, lfsign = 0, rgsign = 1, typestop = mydrivebase.braketank); await wait(250)
            
        await mydrivebase.gyroforwards(465, 1000, typestop = mydrivebase.braketank); await wait(250)
        
        await mydrivebase.turnrightt(72, 35, lfsign = 0, rgsign = -1, typestop = mydrivebase.braketank); await wait(250)
        await mydrivebase.syslefttmotor.run_angle(1000, -180); await wait(250) # return to

        await mydrivebase.gyroforwards(225, 925, typestop = mydrivebase.braketank); await wait(200)
        
        await multitask(
            mydrivebase.syslefttmotor.run_angle(750, 140),
            mydrivebase.sysrighttmotor.run_angle(1000, 1175)
        ); await wait(250)

        # # ---> Retrieve to base <--- #
        mydrivebase.syslefttmotor.run_angle(1000, -132); await wait(275) # wait a little bit

        await mydrivebase.gyrobackwards(150, 1100, typestop = mydrivebase.braketank); await wait(250)
        await mydrivebase.turnleftt(80, 105, lfsign = -1, rgsign = 0, typestop = mydrivebase.braketank); await wait(250)
        await mydrivebase.gyrobackwards(650, 1100, typestop = mydrivebase.braketank); await waita(250)
