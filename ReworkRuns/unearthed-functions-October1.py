...
class runmethods(object):
    ...
    async def runk3(self): 
        ...
        await mydrivebase.gyroforwards(635, 650, typestop = mydrivebase.stoptank); await wait(500)
        await mydrivebase.turnrightt(90, 50, typestop = mydrivebase.braketank); await wait(500)
        await mydrivebase.gyroforwards(300, 450, typestop = mydrivebase.stoptank); await wait(500)

        await mydrivebase.turnleftt(90, 50, typestop = mydrivebase.braketank, lfsign = 0); await wait(500)
        
        mydrivebase.targetangle = 0
        mydrivebase.PID.integral = 0
        await mydrivebase.gyrobackwards(100, 200, typestop = mydrivebase.braketank)

        await rundegrees(mydrivebase.sysrighttmotor, 500, 500); await wait(500)
        await mydrivebase.gyroforwards(200, 200, typestop = mydrivebase.stoptank); await wait(500)
        await rundegrees(mydrivebase.sysrighttmotor, -500, 500); await wait(500)
