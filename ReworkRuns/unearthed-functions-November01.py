...
class runmethods(object):
    ...
    async def runk3(self):
        ...
        mydrivebase.PID.setconstants(1400, 0, 3); await wait(250)
         
        await mydrivebase.gyroforwards(600, 700, typestop= mydrivebase.braketank);await wait(250)
        await mydrivebase.gyrobackwards(70, 700, typestop = mydrivebase.braketank);await wait(250)
        await mydrivebase.gyroforwards(250, 700, typestop=mydrivebase.braketank);await wait(250)
        await mydrivebase.turnleftt(39, 70, rgsign=0, typestop = mydrivebase.braketank); await wait(250)

        await mydrivebase.gyrobackwards(160, 600, typestop = mydrivebase.braketank); await wait(250)
        await mydrivebase.turnleftt(9, 26, typestop=mydrivebase.braketank)
        await rundegrees(mydrivebase.sysrighttmotor, 170, 150) ; await wait(250)
        await rundegrees(mydrivebase.syslefttmotor, 170, 200) ; await wait(250)
        

        await mydrivebase.gyroforwards(300, 500, typestop = mydrivebase.braketank);await wait(250)
        await rundegrees(mydrivebase.sysrighttmotor, -170, 400)
        ...
        # await mydrivebase.turnrightt(70, 50, lfsign=1, rgsign=-1, typestop = mydrivebase.braketank); await wait(250)
        # await mydrivebase.gyrobackwards(90, 500, typestop=mydrivebase.braketank); await wait(250)
        # await mydrivebase.turnleftt(21, 35, lfsign=-1, rgsign=1,typestop = mydrivebase.braketank); await wait(250)
        # await mydrivebase.gyrobackwards(35, 400, typestop=mydrivebase.braketank)
        # await rundegrees(mydrivebase.syslefttmotor, 200, 400); await wait(250)
        # await mydrivebase.gyrobackwards(500, 900, typestop = mydrivebase.braketank)
    ...
    async def runk4(self):
        ...
        #await mydrivebase.gyroforwards(125, 425, typestop = mydrivebase.braketank); await wait(250)
    ...
    async def runk5(self): # ---> misiune distrusa <--- #

        mydrivebase.PID.setconstants(1235, 0, 2); await wait(200)
        ...
        # ---> Go to metrou <--- #
        # await mydrivebase.gyroforwards(165, 625, typestop = mydrivebase.braketank); await wait(250)
        # await mydrivebase.turnleftt(45, 32, lfsign = 0, rgsign = 1, typestop = mydrivebase.braketank); await wait(250)
        
        # await mydrivebase.gyroforwards(230, 675, typestop = mydrivebase.braketank); await wait(250)
        
        # # # ---> Pull <--- #
        # await mydrivebase.syslefttmotor.run_angle(1100, -425)
        
        # await mydrivebase.gyrobackwards(64, 675, typestop = mydrivebase.braketank); await wait(250)
        # await mydrivebase.gyroforwards(25, 625, typestop = mydrivebase.braketank); await wait(250)
        
        # await mydrivebase.syslefttmotor.run_angle(1000, +450)

        # await mydrivebase.gyrobackwards(166, 675, typestop = mydrivebase.braketank); await wait(250)
        # await mydrivebase.turnrightt(44, 30, lfsign = 1, rgsign = 0, typestop = mydrivebase.braketank); await wait(250)

        # await mydrivebase.gyroforwards(128, 625, typestop = mydrivebase.braketank); await wait(250)
        # await mydrivebase.sysrighttmotor.run_angle(925, -2000)

        # await mydrivebase.gyrobackwards(350, 1100, typestop = mydrivebase.braketank); await wait(250)
    ...
    async def runk6(self): # ---> Bolovani <--- #
        
        mydrivebase.PID.setconstants(750, 0, 2); await wait(200)

        mydrivebase.syslefttmotor.run_angle(1000, 600)
        await mydrivebase.gyroforwards(142, 675, typestop = mydrivebase.braketank); await wait(200)
        ...
        await mydrivebase.gyrobackwards(650, 1000, typestop = mydrivebase.braketank); await wait(250)
