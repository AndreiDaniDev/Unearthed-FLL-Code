...
class runmethods(object):
    ...
    async def runk1(self): 
        ...
        await mydrivebase.gyroforwards(500, 750, typestop = None, offsetlf = 32); await wait(100)
    ...
    async def runk2(self): 
        ...
        await mydrivebase.gyroforwards(640, 650, typestop = mydrivebase.braketank); await wait(500)
        await mydrivebase.turnrightt(90, 50, typestop = mydrivebase.braketank); await wait(500)
        await mydrivebase.gyroforwards(270, 450, typestop = mydrivebase.stoptank); await wait(500)

        await mydrivebase.turnleftt(90, 50, typestop = mydrivebase.stoptank, lfsign = 0); await wait(500)
             
        mydrivebase.targetangle = 0
        mydrivebase.PID.integral = 0
        await mydrivebase.gyrobackwards(80, 300, typestop = mydrivebase.stoptank)

        await rundegrees(mydrivebase.sysrighttmotor, -390, 500); await wait(500)
        await mydrivebase.gyroforwards(21 , 350, typestop = mydrivebase.stoptank); await wait(500)
        await rundegrees(mydrivebase.sysrighttmotor, 255, 400); await wait(500)
        await mydrivebase.gyroforwards(185, 500, typestop = mydrivebase.braketank); await wait(500)
        await rundegrees(mydrivebase.syslefttmotor, -1000, 800); await wait(250)

        await rundegrees(mydrivebase.syslefttmotor, 900, 600)

        await mydrivebase.gyrobackwards(120, 400, typestop = mydrivebase.braketank); await wait(200)
        await mydrivebase.turnrightt(85, 100, typestop = mydrivebase.braketank); await wait(200)
        await mydrivebase.gyrobackwards(300, 1000, typestop = mydrivebase.braketank); await wait(200)
        await mydrivebase.turnleftt(70, 200, typestop = mydrivebase.braketank, lfsign = 0); await wait(500)
        ...
        #await multitask(
        #mydrivebase.gyroforwards(40, 100, typestop=mydrivebase.stoptank),
        #delayfunction(lambda: rundegrees(mydrivebase.sysrighttmotor, 250, 1000))
#)
        return None
    async def runk3(self):
        ...
        await mydrivebase.gyroforwards(155, 800, typestop = mydrivebase.braketank); await wait(150)
        await mydrivebase.turnrightt(35, 45, typestop = mydrivebase.braketank); await wait(150)
        await mydrivebase.gyroforwards(367, 700, typestop = mydrivebase.braketank); await wait(150)
        await mydrivebase.turnleftt(75, 45, typestop = mydrivebase.braketank)
        await mydrivebase.gyroforwards(230, 800, typestop = mydrivebase.braketank)
        await rundegrees(mydrivebase.sysrighttmotor, -125, 450); await wait(50)
        await mydrivebase.gyrobackwards(50, 800, typestop = mydrivebase.braketank)
        await mydrivebase.turnrightt(40, 100, lfsign=0, rgsign=-1, typestop = mydrivebase.braketank)
        await mydrivebase.gyrobackwards(600, 1200, typestop = mydrivebase.braketank)

        await mydrivebase.gyroforwards(280, 800, typestop = mydrivebase.braketank); await wait(100)
        await mydrivebase.gyroforwards(45, 700, typestop = mydrivebase.braketank); await wait(100)
        await mydrivebase.gyrobackwards(70, 600, typestop = mydrivebase.braketank); await wait(150)
        await rundegrees(mydrivebase.syslefttmotor, -50, 60); await wait(250)

        await mydrivebase.gyrobackwards(370, 1200, typestop = mydrivebase.braketank)
    ...
    async def runk4(self):
        ...
        await mydrivebase.gyroforwards(440, 600, typestop = mydrivebase.braketank); await wait(200)
        await mydrivebase.gyrobackwards(440, 600, typestop = mydrivebase.braketank)
    ...
    async def runk5(self): 
        ...
        mydrivebase.PID.setconstants(300, 0, 2); await wait(200)
    ...
    async def runk6(self):
        
        mydrivebase.PID.setconstants(750, 0, 2); await wait(200)

        await mydrivebase.gyroforwards(300, 700, typestop = mydrivebase.braketank); await wait(500)
        await rundegrees(mydrivebase.syslefttmotor, -340, 500); await wait(500)
        await rundegrees(mydrivebase.syslefttmotor, 680, 500);await wait(700)
        await rundegrees(mydrivebase.syslefttmotor, -680, 500); await wait(500)
        await rundegrees(mydrivebase.syslefttmotor, 680, 500);await wait(700)
        await rundegrees(mydrivebase.syslefttmotor, -680, 500); await wait(500)
        await rundegrees(mydrivebase.syslefttmotor, 680, 500);await wait(700)
        await mydrivebase.gyrobackwards(150, 700, typestop = mydrivebase.braketank)
    ...
    async def runk7(self):
        ...
        await mydrivebase.syslefttmotor.run_angle(1000, 600)
        await mydrivebase.gyroforwards(140, 675, typestop = mydrivebase.braketank); await wait(200)
        await mydrivebase.turnleftt(32, 30, lfsign = 0, rgsign = 1, typestop = mydrivebase.braketank); await wait(250)
        
        await mydrivebase.gyroforwards(478, 750, typestop = mydrivebase.braketank); await wait(250)
        
        await mydrivebase.turnrightt(71, 38, lfsign = 0, rgsign = -1, typestop = mydrivebase.braketank); await wait(250)
        await mydrivebase.syslefttmotor.run_angle(1000, -825); await wait(250) # return to

        await mydrivebase.gyroforwards(225, 625, typestop = mydrivebase.braketank); await wait(200)
        
        await mydrivebase.syslefttmotor.run_angle(1000, 550); await wait(250)
        await mydrivebase.sysrighttmotor.run_angle(1000, 925); await wait(250)  
        
        # ---> Retrieve to base <--- #
        await mydrivebase.syslefttmotor.run_angle(1000, -475); await wait(250)
