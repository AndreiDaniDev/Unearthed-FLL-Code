...
class runmethods(object):
    ...
    async def runk7(self):
        ...
        mydrivebase.PID.setconstants(1375, 1175, 2, 0, 925); await wait(200); # ~small deadzone, because we need to be really precise with all movements (tested)
        ...
        await mydrivebase.turnleftt(52, 28, lfsign = -1, rgsign = 1, typestop = mydrivebase.holdtank); await wait(500)
        await mydrivebase.gyroforwards(250, 750, typestop = mydrivebase.holdtank, initpid = 0); await wait(250)

        await mydrivebase.turnleftt(22, 22, lfsign = 0, rgsign = 1, typestop = mydrivebase.holdtank); await wait(500)
        ...
        await mydrivebase.turnleftt(17, 28, lfsign = 0, rgsign = 1, typestop = mydrivebase.holdtank); await wait(250);
        await mydrivebase.gyroforwards(310, 750, typestop = mydrivebase.holdtank, initpid = 0); await wait(250)

        await mydrivebase.turnleftt(16, 28, lfsign = 0, rgsign = 1, typestop = mydrivebase.holdtank); await wait(250);
        await mydrivebase.gyroforwards(275, 750, typestop = mydrivebase.holdtank, initpid = 0); await wait(250)

        await mydrivebase.turnleftt(73, 28, lfsign = 0, rgsign = 1, typestop = mydrivebase.braketank); await wait(250);
        await mydrivebase.gyroforwards(100, 750, typestop = mydrivebase.holdtank, initpid = 0); await wait(250)

        mydrivebase.syslefttmotor.run_angle(925, -2800) # ---> Leave all elements <--- #
        await mydrivebase.turnleftt(32, 32, lfsign = 0, rgsign = 1, typestop = mydrivebase.braketank); await wait(250)
        
        await runanglestalltime(mydrivebase.sysrighttmotor, -1100, 3000) # ---> leave minecart <--- ///
