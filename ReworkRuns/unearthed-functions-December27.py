...
class runmethods(object):
    ...
    async def runk3(self):
        ...
        #-->mission 1<--#
        await mydrivebase.gyroforwards(660, 600, typestop = mydrivebase.braketank);await wait(200)
        ...
        await mydrivebase.gyroforwards(70, 400, typestop=mydrivebase.braketank);await wait(200)
        
        #-->mission 15<--#
        await rundegrees(mydrivebase.sysrighttmotor, 170, 600)
        await mydrivebase.turnleftt(60, 140, rgsign=0, typestop=mydrivebase.braketank)
        ...
        await mydrivebase.gyrobackwards(30, 120, typestop=mydrivebase.braketank)
        await rundegrees(mydrivebase.syslefttmotor, -170, 500)
