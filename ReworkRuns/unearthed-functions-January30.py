...
class runmethods(object):
    ...
    async def runk7(self):
        ...
        mydrivebase.PID.setconstants(1375, 1750, 3, 0, 1000); await wait(200); # ~small deadzone, because we need to be really precise with all movements (tested)
        ...
        await delayfunction(750, lambda: mydrivebase.turnleftt(32, 32, lfsign = -1, rgsign = 1, typestop = mydrivebase.braketank)); await wait(250)
