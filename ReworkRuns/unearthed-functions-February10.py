...
class DriveBase_Controller(object):
    ...
    async def trytimelimit(func, ttime: int, typestop) -> None:
...
class runmethods(object):
    ...
    async def runk7(self):
        ...
        mydrivebase.syslefttmotor.run_angle(925, -2800); await wait(1250); # ---> Leave all elements <--- #
        await trytimelimit(lambda: mydrivebase.turnleftt(32, 32, lfsign = -1, rgsign = 1, typestop = mydrivebase.braketank), 2000, mydrivebase.braketank); await wait(250)
