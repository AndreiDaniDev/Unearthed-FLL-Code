...
class runmethods(object):
    ...
    async def runk3(self): 
        ...
        await mydrivebase.gyroforwards(632, 650, typestop = mydrivebase.stoptank); await wait(500)
        await mydrivebase.turnrightt(90, 50, typestop = mydrivebase.braketank); await wait(500)
        await mydrivebase.gyroforwards(275, 450, typestop = mydrivebase.stoptank); await wait(500)

        await mydrivebase.turnleftt(88, 50, typestop = mydrivebase.braketank, lfsign = 0); await wait(500)
             
        mydrivebase.targetangle = 0
        mydrivebase.PID.integral = 0
        await mydrivebase.gyrobackwards(85, 300, typestop = mydrivebase.braketank)

        await rundegrees(mydrivebase.sysrighttmotor, -390, 500); await wait(500)
        await mydrivebase.gyroforwards(17 , 350, typestop = mydrivebase.braketank); await wait(500)
        await rundegrees(mydrivebase.sysrighttmotor, 275, 400); await wait(500)
        await mydrivebase.gyroforwards(180, 500, typestop = mydrivebase.braketank); await wait(500)
        await rundegrees(mydrivebase.syslefttmotor, -1000, 600); await wait(500)

        await rundegrees(mydrivebase.syslefttmotor, 900, 600); await wait(500)

        await mydrivebase.gyrobackwards(120, 400, typestop = mydrivebase.braketank); await wait(500)
        await mydrivebase.turnrightt(90, 600, typestop = mydrivebase.braketank); await wait(500)
        await mydrivebase.gyrobackwards(300, 700, typestop = mydrivebase.braketank)
        await mydrivebase.turnleftt(90, 600, typestop = mydrivebase.braketank, lfsign = 0); await wait(500)
