...
class runmethods(object):
    ...
    async def runk5(self): # ---> Stones (needs a lot of tuning with the new sistem) <--- #
        ...
        await mydrivebase.gyroforwards(314, 775, typestop = mydrivebase.braketank, initpid = 0); await wait(250)
    ...
    async def runk6(self): # ---> misiune distrusa <--- # (swapped with runkx with stones (next one)) 
        ...
        await mydrivebase.gyrobackwards(135, 875, typestop = mydrivebase.braketank, initpid = 0); await wait(250)
    ...
    async def runk7(self):
        ...
        await mydrivebase.trytimelimit(lambda: mydrivebase.sysrighttmotor.run_angle(1100, -590), 250, lambda: mydrivebase.sysrighttmotor.brake()); 

        await mydrivebase.gyrobackwards(25, 750, typestop = mydrivebase.braketank, initpid = 1); await wait(250)
        await mydrivebase.gyroforwards(560, 750, typestop = mydrivebase.braketank, initpid = 1, initgyro = 1); await wait(250)

        # ---> go and get the minecart <--- #
        await mydrivebase.turnleftt(62, 40, lfsign = 0, rgsign = 1, typestop = mydrivebase.braketank, lowerspeedbound = 0); await wait(250)
        await mydrivebase.gyroforwards(420, 675, offsetrg = 42, typestop = mydrivebase.braketank, initpid = 0); await wait(250)
        ...
        mydrivebase.sysrighttmotor.run_angle(575, -700); await wait(250); # close while moving 
        await mydrivebase.gyroforwards(527, 675, typestop = mydrivebase.braketank, initpid = 0); await wait(250)

        # ------------------------------------------------------------------------------------------ #
        
        await mydrivebase.turnleftt(95, 40, lfsign = 0, rgsign = 1, typestop = mydrivebase.braketank, lowerspeedbound = 0);
        await mydrivebase.gyroforwards(100, 675, typestop = mydrivebase.braketank, initpid = 0); await wait(250)

        await mydrivebase.syslefttmotor.run_angle(660, 660); await wait(500);
        await mydrivebase.gyrobackwards(50, 750, typestop = mydrivebase.braketank, initpid = 0); await wait(250)
