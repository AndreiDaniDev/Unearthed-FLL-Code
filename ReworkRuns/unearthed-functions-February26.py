...
class runmethods(object):
    ...
    async def runk7(self):
        ...
        await mydrivebase.gyroforwards(550, 672, typestop=mydrivebase.braketank);await wait(250)
        await mydrivebase.turnleftt(57, 40, typestop=mydrivebase.braketank);await wait(250)
        await mydrivebase.gyroforwards(420, 700, typestop=mydrivebase.braketank);await wait(250)
        await mydrivebase.turnleftt(33, 30, lfsign=0, typestop=mydrivebase.braketank);await wait(250)
        await mydrivebase.gyrobackwards(10, 20, typestop=mydrivebase.braketank)
        await rundegrees(mydrivebase.sysrighttmotor, 180, 200);await wait(250)
        await mydrivebase.gyroforwards(150, 400, typestop=mydrivebase.braketank);await wait(250)
        # await mydrivebase.turnlefttb
