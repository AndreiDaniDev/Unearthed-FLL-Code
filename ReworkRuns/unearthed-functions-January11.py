...
class runmethods(object):
    ...
    async def runk7(self):
        ...
        mydrivebase.PID.setconstants(1175, 750, 2, 0, 1000); await wait(200); # ~small deadzone, because we need to be really precise with all movements (remains untested)
        ...
        await mydrivebase.gyroforwards(420, 750, typestop = mydrivebase.holdtank, initpid = 0); await wait(250)
        await mydrivebase.turnleftt(15, 32, lfsign = 0, rgsign = 1, typestop = mydrivebase.braketank); await wait(250)
        await mydrivebase.gyroforwards(210, 750, typestop = mydrivebase.holdtank, initpid = 0); await wait(250)

        await runanglestalled(mydrivebase.sysrighttmotor, 1100, -1400); # ---> Get minecart <--- #

        await mydrivebase.turnrightt(5, 32, lfsign = 1, rgsign = 0, typestop = mydrivebase.braketank); await wait(250)
        ...
        await mydrivebase.gyroforwards(605, 750, typestop = mydrivebase.holdtank, initpid = 0); await wait(250)
