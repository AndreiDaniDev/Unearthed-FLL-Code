...
class runmethods(object):
    ...
    async def runk6(self): 
        ...
        # ---> Go to metrou <--- #
        await mydrivebase.gyroforwards(200, 550, typestop = mydrivebase.braketank); await wait(250)
        await mydrivebase.turnleftt(45, 32, lfsign = 0, rgsign = 1, typestop = mydrivebase.braketank); await wait(250)
        
        await mydrivebase.gyroforwards(235, 525, typestop = mydrivebase.braketank); await wait(250)
        
        # # ---> Pull <--- #
        await mydrivebase.syslefttmotor.run_angle(1000, -350)
        await mydrivebase.gyrobackwards(75, 525, typestop = mydrivebase.braketank); await wait(250)
        # await mydrivebase.gyroforwards(50, 525, typestop = mydrivebase.braketank); await wait(250)
        
        await mydrivebase.syslefttmotor.run_angle(1000, +450)
        # await mydrivebase.gyrobackwards(125, 525, typestop = mydrivebase.braketank); await wait(250)
        # await mydrivebase.turnrightt(45, 32, lfsign = 1, rgsign = 0, typestop = mydrivebase.braketank); await wait(250)
