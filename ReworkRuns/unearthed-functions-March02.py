...
class runmethods(object):
    ...
    async def runk1(self): 
        ...
        await multitask(
            mydrivebase.gyrobackwards(730, 800, typestop=mydrivebase.braketank),
            rundegrees(mydrivebase.sysrighttmotor, -880, 1100) 
        ); await wait(280)
        
        await mydrivebase.turnleftt(89, 32, typestop=mydrivebase.braketank); await wait(500)
        
        await mydrivebase.gyroforwards(170, 180, typestop=mydrivebase.braketank, initpid = 1)
        
        await multitask(
            rundegrees(mydrivebase.syslefttmotor, -70,  200),
            rundegrees(mydrivebase.sysrighttmotor, 600, 500)
        );
        await multitask(
            mydrivebase.gyrobackwards(140, 450, typestop=mydrivebase.braketank, initpid = 1),
            rundegrees(mydrivebase.sysrighttmotor, -610, 1000)
        );await wait(250)

        await mydrivebase.turnrightt(36, 30, typestop=mydrivebase.braketank); await wait(250);
        await mydrivebase.gyroforwards(260, 800, typestop=mydrivebase.braketank);await wait(250);

        await multitask(
        rundegrees(mydrivebase.sysrighttmotor, 400, 400),
        mydrivebase.turnleftt(5, 5, typestop=mydrivebase.braketank)
        );
        await mydrivebase.gyrobackwards(200, 700, typestop=mydrivebase.braketank); await wait(250)
        await mydrivebase.turnrightt(55, 49, typestop=mydrivebase.braketank)
    ...
    async def runk2(self): 
        ...
        await mydrivebase.gyrobackwards(750, 1100, typestop = mydrivebase.braketank, initpid = 0); await wait(250)   
    ...
    async def runk6(self): # ---> misiune distrusa <--- # (swapped with runkx with stones (next one)) 
        ...
        await mydrivebase.trytimelimit(lambda: mydrivebase.sysrighttmotor.run_angle(900, -2000), 2750, lambda: mydrivebase.sysrighttmotor.hold()); await wait(250)
    ...
    async def runk7(self):
        ...
        await mydrivebase.trytimelimit(lambda: mydrivebase.sysrighttmotor.run_angle(1100, -350), 250, lambda: mydrivebase.sysrighttmotor.hold()); # ---> force arm <--- #
        ...
        await mydrivebase.trytimelimit(lambda: mydrivebase.sysrighttmotor.run_angle(750, 400), 750, lambda: mydrivebase.sysrighttmotor.hold()); await wait(1000)
        
        # ---> retrieve long arm with minecart <--- #
        await mydrivebase.gyroforwards(72, 425, typestop = mydrivebase.braketank, initpid = 0); await wait(250)
        await mydrivebase.trytimelimit(lambda: mydrivebase.sysrighttmotor.run_angle(175, -400), 2500, lambda: mydrivebase.sysrighttmotor.hold()); await wait(1000)

        # ---> go to leave all elements :D <--- #
        await mydrivebase.turnleftt(16, 30, lfsign = 0, rgsign = 1, typestop = mydrivebase.braketank, lowerspeedbound = 30); await wait(250)
        await mydrivebase.gyroforwards(462, 425, typestop = mydrivebase.braketank, initpid = 0); await wait(250)
        await mydrivebase.turnleftt(62, 32, lfsign = 0, rgsign = 1, typestop = mydrivebase.braketank, lowerspeedbound = 32); await wait(250)
        await mydrivebase.gyrobackwards(25, 425, typestop = mydrivebase.braketank, initpid = 0); await wait(250)
        
        # # ---> leave all elements <--- #
        await mydrivebase.trytimelimit(lambda: mydrivebase.sysrighttmotor.run_angle(175, +300), 2500, lambda: mydrivebase.sysrighttmotor.hold())
        await mydrivebase.trytimelimit(lambda: mydrivebase.syslefttmotor.run_angle(1100, -5100), 5000, lambda: mydrivebase.syslefttmotor.hold())
        await mydrivebase.trytimelimit(lambda: mydrivebase.sysrighttmotor.run_angle(250, -375), 1500, lambda: mydrivebase.sysrighttmotor.hold())
        mydrivebase.sysrighttmotor.run_angle(1100, -375); # ---> leave the minecart <--- # 

        await mydrivebase.gyroforwards(125, 425, typestop = mydrivebase.braketank, initpid = 0); await wait(250)
        await mydrivebase.gyrobackwards(100, 425, typestop = mydrivebase.braketank, initpid = 0); await wait(250)        
