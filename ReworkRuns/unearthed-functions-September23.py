...
class runmethods(object):
    ...
    async def runk2(self): 
        ...
        await mydrivebase.turnrightt(45, 45, typestop = mydrivebase.braketank); await wait(500)
        await mydrivebase.gyroforwards(375, 600, typestop = mydrivebase.braketank); await wait(500)
       # await mydrivebase.turnrightt(20, 120, typestop= mydrivebase.braketank); await wait(1000)
        #await mydrivebase.gyroforward(30, 400, typestop= mydrivebase.braketank)
        #await mydrivebase.turnleftt(110, 120, typestop = mydrivebase.braketank); await wait(1000)

        # await rundegrees(mydrivebase.syslefttmotor, 1000, 1000)
        # await rundegrees(mydrivebase.syslefttmotor, -1000, 1000)
