...
class runmethods(object):
    ...
    async def runk6(self):
        ...
        mydrivebase.syslefttmotor.run_angle(1000, 500)
        await mydrivebase.gyroforwards(158, 675, typestop = mydrivebase.braketank); await wait(200)
        await mydrivebase.turnleftt(30, 30, lfsign = 0, rgsign = 1, typestop = mydrivebase.braketank); await wait(250)
        
        await mydrivebase.gyroforwards(457, 750, typestop = mydrivebase.braketank); await wait(250)
        await mydrivebase.syslefttmotor.run_angle(1000, -750); await wait(250) # return to
    
        await mydrivebase.turnrightt(72, 40, lfsign = 1, rgsign = -1, typestop = mydrivebase.braketank); await wait(250)

        await mydrivebase.gyroforwards(200, 750, typestop = mydrivebase.braketank); await wait(200)
        
        await mydrivebase.syslefttmotor.run_angle(1000, 425); await wait(250)
        await mydrivebase.sysrighttmotor.run_angle(1000, 1000); await wait(250)
