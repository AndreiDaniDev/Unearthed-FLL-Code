...
class runmethods(object):
    ...
    async def runk1(self): 
        ...
        mydrivebase.PID.setconstants(925, 0, 0); await wait(200)
        ...
        await mydrivebase.gyroforwards(200, 300, initpid=0, typestop=mydrivebase.braketank); await wait(200)

        await multitask(
            rundegrees(mydrivebase.sysrighttmotor, -250, 600),
            rundegrees(mydrivebase.syslefttmotor, 135, 80)
           ); await wait(200);

        await mydrivebase.gyrobackwards(40, 130, typestop=mydrivebase.braketank)
        await mydrivebase.gyrobackwards(50, 70, typestop=mydrivebase.braketank)
        #)
