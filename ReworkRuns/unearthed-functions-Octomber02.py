...
async def delayfunction(value: int, myfunc) -> None:
    await wait(value); await myfunc(); return
...
class runmethods(object):
    ...
    async def runk3(self): 
        ...
        # await mydrivebase.gyroforwards(285, 450, typestop = mydrivebase.stoptank); await wait(500)
        ...
        await multitask(
        rundegrees(mydrivebase.sysrighttmotor, -250, 400),
        mydrivebase.gyroforwards(80, 305, typestop = mydrivebase.stoptank)
        )
