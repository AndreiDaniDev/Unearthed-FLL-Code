...
mydrivebase = DriveBase_Controller(
    ...
    stallspeed = 100, ttimestall = 250, signencoder = 1,
...
class runmethods(object):
    ...
    async def runk7(self):
        ...
        mydrivebase.PID.setconstants(1375, 750, 2, 0, 1000); await wait(200); # ~small deadzone, because we need to be really precise with all movements (tested)
        ...
        await mydrivebase.gyrobackwards(110, 750, typestop = mydrivebase.holdtank, initpid = 0); await wait(250)

        await mydrivebase.turnleftt(95, 32, lfsign = 0, rgsign = 1, typestop = mydrivebase.braketank); await wait(250)
        await mydrivebase.gyroforwards(475, 750, typestop = mydrivebase.holdtank, initpid = 0); await wait(250)

        await mydrivebase.turnleftt(85, 32, lfsign = -1, rgsign = 1, typestop = mydrivebase.braketank); await wait(250)
        ...
        await mydrivebase.gyroforwards(65, 225, typestop = mydrivebase.braketank, initpid = 1); await wait(250)
