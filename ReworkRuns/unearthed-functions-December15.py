...
class runmethods(object):
    ...
    async def runk7(self):
        ...
        mydrivebase.sysrighttmotor.run_angle(675, 86); # ---> Lift rightt (minecart) arm <---  
        ...
        await mydrivebase.gyroforwards(14, 425, typestop = mydrivebase.braketank); await wait(250)
        ...
        await mydrivebase.turnleftt(20, 42, lfsign = 0, rgsign = 1, typestop = mydrivebase.braketank); await wait(250) # >>> May work without this <<< #
