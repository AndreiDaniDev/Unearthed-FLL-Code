...
class runmethods(object):
    ...
    async def runk4(self):
         ...
         await mydrivebase.turnleftt(57, 45, typestop = mydrivebase.braketank); await wait(500)
         await mydrivebase.gyroforwards(325, 400, typestop = mydrivebase.braketank); await wait(500)

        #  await mydrivebase.gyrobackwards(175, 500, typestop = mydrivebase.braketank); await wait(500)
        #  await mydrivebase.turnrightt(57, 45, typestop = mydrivebase.braketank); await wait(500)
