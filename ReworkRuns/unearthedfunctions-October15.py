...
class runmethods(object):
    ...
    async def runk6(self):
        ...
        await mydrivebase.sysrighttmotor.run_angle(1000, 1100); await wait(250)  
        
        # ---> Retrieve to base <--- #
        await mydrivebase.syslefttmotor.run_angle(1000, -475); await wait(250)

        await mydrivebase.gyrobackwards(117, 625, typestop = mydrivebase.braketank); await wait(250)
        await mydrivebase.turnleftt(75, 36, lfsign = -1, rgsign = 0, typestop = mydrivebase.braketank); await wait(250)
        await mydrivebase.gyrobackwards(575, 1000, typestop = mydrivebase.braketank); await wait(250)
