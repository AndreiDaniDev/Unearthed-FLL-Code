...
class runmethods(object):
    ...
    async def runk3(self):
        ...
        await mydrivebase.gyroforwards(520, 750, typestop = mydrivebase.braketank); await wait(500)
        await mydrivebase.gyrobackwards(71, 600, typestop = mydrivebase.braketank); await wait(150)
        await rundegrees(mydrivebase.syslefttmotor, -50, 60); await wait(250)

        await mydrivebase.gyrobackwards(470, 1200, typestop = mydrivebase.braketank)
    ...
    async def runk4(self):
        ...
        await mydrivebase.gyroforwards(300, 700, typestop = mydrivebase.braketank); await wait(250)
        await mydrivebase.turnrightt(35, 45, typestop = mydrivebase.braketank); await wait(250)
        await mydrivebase.gyroforwards(367, 700, typestop = mydrivebase.braketank); await wait(250)
        await mydrivebase.turnleftt(80, 45, typestop = mydrivebase.braketank); await wait(250)
        await mydrivebase.gyroforwards(230, 600, typestop = mydrivebase.braketank); await wait(250)
        await rundegrees(mydrivebase.sysrighttmotor, 100, 300)
    ...
    async def runk6(self): # ---> Misiune distrusa <--- #
        
        mydrivebase.PID.setconstants(1375, 0, 2); await wait(200)
        ...
        # await mydrivebase.gyroforwards(352, 775, typestop = mydrivebase.braketank); await wait(250)
        # await mydrivebase.sysrighttmotor.run_angle(925, -2000); await wait(250)

        # -------------------------------------------------------------------------------------- #

    async def runk7(self): # ---> Bolovani <--- #
