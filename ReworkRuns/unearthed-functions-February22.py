...
class runmethods(object):
    ...
    async def runk1(self): 
        ...
        await multitask(
            ...
            rundegrees(mydrivebase.sysrighttmotor, -600, 1000)
        );
        await mydrivebase.turnrightt(36, 36, typestop=mydrivebase.braketank)
        await mydrivebase.gyroforwards(260, 800, typestop=mydrivebase.braketank)
        await multitask(
        rundegrees(mydrivebase.sysrighttmotor, 400, 400),
        mydrivebase.turnleftt(7, 7, typestop=mydrivebase.braketank)
        );
    ...
    async def runk2(self): 
        ...
        await mydrivebase.turnleftt(50, 32, lfsign = 0, rgsign = 1, typestop = mydrivebase.braketank); await wait(250);
        
        mydrivebase.sysrighttmotor.run_angle(1100, +165); # force motor
    
        # ---> go to elements <--- #
        await mydrivebase.gyroforwards(225, 750, typestop = mydrivebase.braketank, initpid = 0); await wait(250)
        ...
        await mydrivebase.gyrobackwards(20, 1100, typestop = mydrivebase.braketank, initpid = 0); await wait(250)   
        await mydrivebase.turnrightt(60, 45, lfsign = 0, rgsign = -1, typestop = mydrivebase.braketank); await wait(250)
    ...
    async def runk4(self):
        ...
        await mydrivebase.turnrightt(87, 30, lfsign = 0, rgsign = -1, typestop = mydrivebase.braketank); await wait(250)
        ...
        await mydrivebase.turnleftt(3, 5, rgsign=0, lfsign=1, typestop=mydrivebase.braketank)
