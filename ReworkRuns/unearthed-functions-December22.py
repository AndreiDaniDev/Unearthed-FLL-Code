...
class runmethods(object):
    ...
    async def runk1(self): 
        ...
        await mydrivebase.gyroforwards(415, 750, typestop = None, offsetlf = 32, initpid = 1); await wait(100)
        await mydrivebase.gyroforwards(100, 500, typestop = mydrivebase.braketank, offsetlf = 32, initpid = 0)
        await rundegrees(mydrivebase.sysrighttmotor, -250, 1000)
        await mydrivebase.gyrobackwards(500, 875, typestop = mydrivebase.braketank, offsetrg = 32, initpid = 1); await wait(250)
    ...
    async def runk3(self):
        ...
        await mydrivebase.syslefttmotor.run_angle(1000, -210)

        await rundegrees(mydrivebase.syslefttmotor, -200, 600);await wait(200)
        await rundegrees(mydrivebase.syslefttmotor, 200, 200)
    ...
    async def runk7(self):
        ...
        await mydrivebase.gyroforwards(800, 525, typestop = mydrivebase.braketank, initpid = 1); await wait(250)
        await mydrivebase.turnrightt(78, 16, lfsign = 1, rgsign = 0, typestop = mydrivebase.braketank); await wait(250)

        await mydrivebase.gyroforwards(495, 750, typestop = mydrivebase.braketank, initpid = 0); await wait(250)

        await mydrivebase.sysrighttmotor.run_angle(675, -125); # ---> Lift rightt (minecart) arm <---  

        await mydrivebase.gyrobackwards(92, 750, typestop = mydrivebase.braketank, initpid = 0); await wait(250)
        await mydrivebase.turnleftt(108, 28, lfsign = 0, rgsign = 1, typestop = mydrivebase.braketank); await wait(250)
        await mydrivebase.gyroforwards(432, 625, typestop = mydrivebase.braketank, initpid = 0); await wait(250); # >>> old dist = 400 <<< #
        ...
        await mydrivebase.gyroforwards(45, 575, typestop = mydrivebase.braketank, initpid = 0); await wait(250); 
        ...
        await mydrivebase.gyroforwards(10, 575, typestop = mydrivebase.braketank, initpid = 0); await wait(250)
        await mydrivebase.gyrobackwards(55, 1100, typestop = mydrivebase.braketank, initpid = 0); await wait(250)
