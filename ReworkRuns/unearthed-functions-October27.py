...
class runmethods(object):
    ...
    async def runk3(self):
        ...
        await mydrivebase.gyroforwards(720, 700, typestop= mydrivebase.braketank); await wait(100)
        await mydrivebase.turnleftt(45, 50, lfsign=-1, rgsign=1,typestop = mydrivebase.braketank); await wait(100)
        await mydrivebase.gyrobackwards(154, 600, typestop = mydrivebase.braketank)
        await rundegrees(mydrivebase.syslefttmotor, -170, 150)
        await rundegrees(mydrivebase.sysrighttmotor, 130, 150) ; await wait(100)
        await mydrivebase.gyroforwards(160, 600, typestop = mydrivebase.braketank)
