...
class runmethods(object):
    ...
    async def runk1(self): 
        ...
        await multitask(
              mydrivebase.gyrobackwards(850, 880, typestop=mydrivebase.braketank),
              rundegrees(mydrivebase.sysrighttmotor, 320, 600)
        
        );await wait(250)

        await mydrivebase.turnleftt(91, 40, typestop=mydrivebase.braketank); await wait(200)
        await mydrivebase.gyroforwards(250, 220, typestop=mydrivebase.braketank); await wait(200)

        
        await mydrivebase.syslefttmotor.run_angle(1100, 170);
        await rundegrees(mydrivebase.sysrighttmotor, -290, 290)
        await mydrivebase.gyrobackwards(150, 170, typestop=mydrivebase.braketank);await wait(200)

        await multitask(
            mydrivebase.turnrightt(41, 20, rgsign=0, lfsign=1, typestop=mydrivebase.braketank),
            mydrivebase.sysrighttmotor.run_angle(400, 310)
        ); await wait(200)

        await mydrivebase.gyroforwards(320, 800, typestop=mydrivebase.braketank);await wait(200)

        await multitask(
            mydrivebase.sysrighttmotor.run_angle(1100, -110),
            mydrivebase.turnleftt(8, 10, typestop=mydrivebase.braketank)
        );await wait(200)
        
        await mydrivebase.gyrobackwards(200, 700, typestop=mydrivebase.braketank)
        await mydrivebase.turnrightt(45, 45, typestop=mydrivebase.braketank)
        await mydrivebase.gyroforwards(800, 1100, typestop=mydrivebase.braketank)

        # mydrivebase.sysrighttmotor.run_angle(1100, -890); # init arm
        # await mydrivebase.gyroforwards(8, 1100, typestop = mydrivebase.braketank, initpid = 0); await wait(250)

        # await mydrivebase.gyrobackwards(720, 975, typestop = mydrivebase.braketank, initpid = 1); await wait(250)
        # await mydrivebase.turnleftt(93, 45, lfsign = 0, rgsign = 1, typestop = mydrivebase.braketank, lowerspeedbound = 45); await wait(250)

        # await mydrivebase.gyroforwards(137, 375, typestop = mydrivebase.braketank, initpid = 0); await wait(250)

        # mydrivebase.syslefttmotor.run_angle(325, -100); # keep it forced 

        # await mydrivebase.sysrighttmotor.run_angle(475, 625); await wait(250)

        # mydrivebase.sysrighttmotor.run_angle(1100, -632); await wait(250)
        # await mydrivebase.gyrobackwards(114, 975, typestop = mydrivebase.braketank, initpid = 0); await wait(250)
        # await mydrivebase.turnrightt(40, 36, lfsign = 1, rgsign = 0, typestop = mydrivebase.braketank, lowerspeedbound = 32); await wait(250)

        # await mydrivebase.gyroforwards(225, 925, typestop = mydrivebase.braketank, initpid = 1); await wait(250)
        
        # mydrivebase.sysrighttmotor.run_angle(475, 175); # ---> if we have a bad run and can't complete the shark we will get tle and exit :D <--- #
        # await mydrivebase.trytimelimit(lambda: mydrivebase.turnleftt(8, 32, lfsign = 0, rgsign = 1, typestop = mydrivebase.braketank, lowerspeedbound = 32), 2500, mydrivebase.braketank); await wait(250)

        # await mydrivebase.gyrobackwards(265, 1100, typestop = mydrivebase.braketank, initpid = 0); await wait(250)
        # await mydrivebase.turnrightt(72, 45, lfsign = 1, rgsign = 0, typestop = mydrivebase.braketank, lowerspeedbound = 32); await wait(250)

        # await mydrivebase.gyroforwards(575, 1100, typestop = mydrivebase.braketank, initpid = 0); await wait(250)
    ...
    async def runk2(self): 
        ...
        mydrivebase.PID.setconstants(1750, 0, 2, alphanoise = 750, deadzone = 0); await wait(200)
        ...
        await multitask(
            mydrivebase.gyroforwards(712, 675, typestop = mydrivebase.braketank, initpid = 1), 
        ...
        # ---> go to elements <--- #
        await mydrivebase.gyroforwards(230, 925, typestop = mydrivebase.braketank, initpid = 0); await wait(250)
    ...
    async def runk4(self):
        ...
        await mydrivebase.gyroforwards(90, 555, typestop = mydrivebase.braketank, initpid = 1); await wait(500)

        await mydrivebase.turnrightt(83, 30, lfsign = 0, rgsign = -1, typestop = mydrivebase.braketank); await wait(250)
        ...
        await mydrivebase.gyrobackwards(325, 750, typestop = mydrivebase.braketank, offsetlf=42); await wait(250)
        await mydrivebase.gyroforwards(130, 1100, typestop = mydrivebase.braketank, initpid = 0); await wait(250)
    ...
    async def runk5(self): # ---> Stones (needs a lot of tuning with the new sistem) <--- #
        ...
        await mydrivebase.gyroforwards(330, 675, typestop = mydrivebase.braketank, initpid = 0); await wait(250)
        ...
        await multitask(
            # delayfunction(575, lambda:
            mydrivebase.gyroforwards(250, 280, typestop = mydrivebase.braketank, initpid = 0),
            mydrivebase.sysrighttmotor.run_angle(1100, 1775)
        ); await wait(500)

        await multitask(
            mydrivebase.sysrighttmotor.run_angle(1100, -1555),
            mydrivebase.syslefttmotor.run_angle(1100, 370)
            # mydrivebase.trytimelimit(lambda: mydrivebase.syslefttmotor.run_angle(1100, 350), 775, lambda: mydrivebase.sysrighttmotor.hold()),
            # mydrivebase.trytimelimit(lambda: mydrivebase.sysrighttmotor.run_angle(1100, -3000), 250, None)
        ); await wait(250)
        ...
        await mydrivebase.gyrobackwards(650, 1100, offsetrg = -200, typestop = mydrivebase.braketank, initpid = 0); await wait(250)
    ...
    async def runk6(self): # ---> misiune distrusa <--- # (swapped with runkx with stones (next one)) 
        ...
        await mydrivebase.gyroforwards(310, 775, typestop = mydrivebase.braketank, initpid = 1, typeemsk = 3); await wait(250)
        ...
        await mydrivebase.gyrobackwards(115, 875, typestop = mydrivebase.braketank, initpid = 0); await wait(250)
        await mydrivebase.turnleftt(46, 32, lfsign = 0, rgsign = 1, typestop = mydrivebase.braketank); await wait(250)
        ...
        await mydrivebase.trytimelimit(lambda: mydrivebase.syslefttmotor.run_angle(1000, -425), 1000, lambda: mydrivebase.syslefttmotor.hold())

        await mydrivebase.trytimelimit(lambda: mydrivebase.gyrobackwards(64, 875, typestop = mydrivebase.braketank, initpid = 0), 2000, mydrivebase.braketank); await wait(250)
        ...
        await mydrivebase.trytimelimit(lambda: mydrivebase.syslefttmotor.run_angle(1100, +450), 1000, lambda: mydrivebase.syslefttmotor.hold())
    ...
    async def runk7(self):
        ...
        mydrivebase.PID.setconstants(2150, 0, 0, deadzone = 0, alphanoise = 1000); await wait(200); # ~small deadzone, because we need to be really precise with all movements (tested)
                                                                                    
        # ------------------------------------------------------------------------------------------ #
                                                                                    
        await mydrivebase.gyroforwards(500, 1100, typestop=mydrivebase.braketank);await wait(200)     
        await mydrivebase.turnleftt(60, 35, lfsign=0, rgsign=1, typestop=mydrivebase.braketank); await wait(200)

        await mydrivebase.gyroforwards(400, 500, typestop=mydrivebase.braketank); await wait(200)     
        await mydrivebase.turnleftt(30, 15, lfsign=0, typestop=mydrivebase.braketank); await wait(200)

        await rundegrees(mydrivebase.sysrighttmotor, 500, 500); await wait(200)                       
        await mydrivebase.gyroforwards(100, 500, typestop=mydrivebase.braketank);await wait(200)
        await rundegrees(mydrivebase.sysrighttmotor, -430, 235)                                       
        
        await mydrivebase.gyroforwards(270, 500, typestop=mydrivebase.braketank)                      
        await mydrivebase.turnleftt(40, 20, lfsign=0, typestop=mydrivebase.braketank)                 
        await mydrivebase.gyroforwards(200, 300, typestop=mydrivebase.braketank)   
        await mydrivebase.turnleftt(50, 25, lfsign=0, typestop=mydrivebase.braketank) 
        await multitask(
            rundegrees(mydrivebase.syslefttmotor, 660, 660),
            rundegrees(mydrivebase.sysrighttmotor, -30, 100)
        ); await wait(250)
        await mydrivebase.gyrobackwards(100, 1100, typestop=mydrivebase.braketank)

        # await mydrivebase.trytimbelimit(lambda: mydrivebase.sysrighttmotor.run_angle(1100, -590), 250, lambda: mydrivebase.sysrighttmotor.hold()); # ---> force arm <--- #
        # await mydrivebase.gyrobackwards(25, 750, typestop = mydrivebase.braketank, initpid = 1); await wait(250)
        # await mydrivebase.gyroforwards(610, 375, typestop = mydrivebase.braketank, initpid = 1); await wait(250)
        
        # # ---> go and get the minecart <--- #
        # await mydrivebase.turnleftt(50, 32, lfsign = 0, rgsign = 1, typestop = mydrivebase.braketank, lowerspeedbound = 32); await wait(250)
        # await mydrivebase.gyroforwards(190, 375, typestop = mydrivebase.braketank, initpid = 0); await wait(250)
        # await mydrivebase.turnleftt(35, 32, lfsign = 0, rgsign = 1, typestop = mydrivebase.braketank, lowerspeedbound = 32); await wait(250)
        # await mydrivebase.gyroforwards(230, 375, typestop = mydrivebase.braketank, initpid = 0); await wait(250)
        ...
        # # ---> retrieve long arm with minecart <--- #
        # await multitask(
        #     mydrivebase.gyroforwards(72, 425, typestop = mydrivebase.braketank, initpid = 0),
        #    mydrivebase.trytimelimit(lambda: mydrivebase.sysrighttmotor.run_angle(250, -700), 2500, lambda: mydrivebase.sysrighttmotor.hold())
        # ); await wait(325);

        # # ---> go to leave all elements :D <--- #
        # await mydrivebase.turnleftt(18, 28, lfsign = 0, rgsign = 1, typestop = mydrivebase.braketank, lowerspeedbound = 28); await wait(250)
        # await mydrivebase.gyroforwards(462, 425, typestop = mydrivebase.braketank, initpid = 0); await wait(250)
        # await mydrivebase.turnleftt(70, 32, lfsign = 0, rgsign = 1, typestop = mydrivebase.braketank, lowerspeedbound = 32); await wait(250)
        # await mydrivebase.gyrobackwards(25, 425, typestop = mydrivebase.braketank, initpid = 0); await wait(250)
        
        # # # ---> leave all elements <--- #
        # await multitask(
        #     mydrivebase.trytimelimit(lambda: mydrivebase.sysrighttmotor.run_angle(250, +400), 2500, lambda: mydrivebase.sysrighttmotor.hold()),
        #     mydrivebase.trytimelimit(lambda: mydrivebase.syslefttmotor.run_angle(1100, -4600), 5000, lambda: mydrivebase.syslefttmotor.hold())
        # ); 
        # await mydrivebase.trytimelimit(lambda: mydrivebase.sysrighttmotor.run_angle(375, -250), 1500, lambda: mydrivebase.sysrighttmotor.hold())
        # mydrivebase.sysrighttmotor.run_angle(1100, -650); # ---> leave the minecart <--- # 

        # await mydrivebase.gyroforwards(43, 775, typestop = mydrivebase.braketank, initpid = 0); await wait(250)
        # await mydrivebase.gyrobackwards(100, 1100, typestop = mydrivebase.braketank, initpid = 0); await wait(250)        
