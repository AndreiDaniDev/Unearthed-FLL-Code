...
class runmethods(object):
    ...
    async def runk1(self): 
        ...
        await mydrivebase.turnrightt(36, 36, typestop=mydrivebase.braketank); await wait(250);
        ...
        await mydrivebase.turnrightt(55, 55, typestop=mydrivebase.braketank)
    ...
    async def runk7(self):
        ...
        # mydrivebase.PID.setconstants(1950, 1550, 2, 0, 1000); await wait(200); # ~small deadzone, because we need to be really precise with all movements (tested)
        mydrivebase.PID.setconstants(1750, 2500, 3, deadzone = 0, alphanoise = 1000); await wait(200); # ~small deadzone, because we need to be really precise with all movements (tested)
        

        # await mydrivebase.gyroforwards(200, 400, typestop=mydrivebase.braketank)
        # await mydrivebase.turnleftt(90, 87, typestop = mydrivebase.braketank)


        await mydrivebase.gyroforwards(550, 630, typestop=mydrivebase.braketank);await wait(250)
        await mydrivebase.turnleftt(58, 40, typestop=mydrivebase.braketank);await wait(250)
        await mydrivebase.gyroforwards(440, 700, typestop=mydrivebase.braketank);await wait(250)
        await mydrivebase.turnleftt(33, 30, lfsign=0, typestop=mydrivebase.braketank);await wait(250)
        await mydrivebase.gyrobackwards(20, 30, typestop=mydrivebase.braketank)
        await rundegrees(mydrivebase.sysrighttmotor, 170, 200);await wait(250)
        await mydrivebase.gyroforwards(300, 400, typestop=mydrivebase.braketank);await wait(250)
        await mydrivebase.turnleftt(17, 15, typestop=mydrivebase.braketank)
