...
class runmethods(object):
    ...
    async def runk1(self): 
        ...
        await multitask(
            mydrivebase.gyrobackwards(830, 975, typestop=mydrivebase.braketank),
            rundegrees(mydrivebase.syslefttmotor, -80, 80)
        ); await wait(200)

        await mydrivebase.turnleftt(92, 45, typestop=mydrivebase.braketank); await wait(200)
        #await multitask(
        await rundegrees(mydrivebase.sysrighttmotor, 310, 600)
