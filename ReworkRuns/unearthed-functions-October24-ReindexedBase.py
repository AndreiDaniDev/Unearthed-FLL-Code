...
class runmethods(object):
    ...
    async def runk6(self): 
        ...
        await mydrivebase.syslefttmotor.run_angle(1000, 125)

        # ---> Go to metrou <--- #
        await mydrivebase.gyroforwards(165, 550, typestop = mydrivebase.braketank); await wait(250)
        ...
        await mydrivebase.gyroforwards(25, 525, typestop = mydrivebase.braketank); await wait(250)
