...
class runmethods(object):
    ...
    async def runk7(self):
        ...
        await mydrivebase.gyroforwards(225, 750, typestop = mydrivebase.holdtank, initpid = 0); await wait(250)

        await mydrivebase.turnleftt(73, 28, lfsign = 0, rgsign = 1, typestop = mydrivebase.braketank); await wait(250);
        await mydrivebase.gyroforwards(200, 750, typestop = mydrivebase.holdtank, initpid = 0); await wait(250)
