...
class runmethods(object):
    ...
    async def runk3(self): 
        ...
        await mydrivebase.gyroforwards(633, 650, typestop = mydrivebase.stoptank); await wait(500)
        await mydrivebase.turnrightt(90, 50, typestop = mydrivebase.braketank); await wait(500)
        await mydrivebase.gyroforwards(258, 450, typestop = mydrivebase.stoptank); await wait(500)

        await mydrivebase.turnleftt(88, 50, typestop = mydrivebase.braketank, lfsign = 0); await wait(500)
             
        mydrivebase.targetangle = 0
        mydrivebase.PID.integral = 0
        await mydrivebase.gyrobackwards(90, 300, typestop = mydrivebase.braketank)

        await rundegrees(mydrivebase.sysrighttmotor, -390, 500); await wait(500)
        await mydrivebase.gyroforwards(18, 450, typestop = mydrivebase.braketank); await wait(500)
        await rundegrees(mydrivebase.sysrighttmotor, 270, 1000); await wait(500)
        await mydrivebase.gyroforwards(80, 200, typestop = mydrivebase.stoptank); await wait(500)
